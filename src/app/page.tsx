...
const HomePage = memo(function HomePage() {
  ...
  }), [board, selectedPositions, animatingPositions, justSwappedPositions, swapAnimation, isGenerating, handleTileClick, handleSwapAnimationComplete]);
  ...
  }), [isLoading, movesRemaining, isGenerating, isLoadingClassic, showAIPrompts, getSuggestion, resetGame, generateNewPuzzle, useClassicPuzzle, handleToggleAIPrompts]);
  ...
  }), [showGameEndDialog, gameStatus, moveCount, maxMoves, handleGameEndRestart, handleGameEndNewGame, handleGameEndClose]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50/80 via-gray-50/60 to-blue-50/75">
        ...
        {/* 游戏主区域 - 填满整个可见区域并垂直居中 */}
        <div className="flex flex-col items-center justify-center gap-6 py-6 w-full" style={gameAreaStyle}>
