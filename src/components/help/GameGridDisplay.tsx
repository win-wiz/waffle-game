...
const WaffleTile: React.FC<WaffleTileProps> = React.memo(({
  ...
  return (
    <div className={`${baseClasses} flex items-center justify-center font-bold text-lg rounded-lg ${intersectionClasses} ${colorClasses[color]}`}>
      {letter}
    </div>
  );
});
  ...
  return (
    <div className="py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-slate-800 mb-12">🧩 Game Grid Example</h2>
        <div className="inline-block mb-12">
          <WaffleGrid />
        </div>
        <p className="text-slate-700 text-xl mb-16 max-w-4xl mx-auto leading-relaxed">
          Each tile is numbered (0-20) and colored according to its state. Blue rings mark intersection positions where letters must work for both horizontal and vertical words.
        </p>
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-slate-800 mb-8">📍 Grid Layout Description</h3>
          <div className="grid lg:grid-cols-2 gap-12 text-left max-w-4xl mx-auto">
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-slate-700 mb-4">Horizontal Words:</h4>
            ...
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-slate-700 mb-4">Vertical Words:</h4>
              <ul className="space-y-3 text-slate-700 text-lg">
                <li className="flex items-center gap-3">
