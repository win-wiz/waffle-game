...
const WaffleTile: React.FC<WaffleTileProps> = React.memo(({
  ...
  const computedClasses = useMemo(() => {
    ...
    const intersectionClasses = isIntersection ? 'ring-4 ring-blue-500 ring-offset-2 shadow-lg' : 'shadow-md';
...
const HorizontalWordExample: React.FC<{
  letters: Array<{letter: string, color: 'green' | 'yellow' | 'gray' | 'white'}>,
  title: string,
  description: string
}> = React.memo(({ letters, title, description }) => {
  const renderedTiles = useMemo(() =>
    letters.map((item, index) => (
      <WaffleTile key={index} letter={item.letter} color={item.color} className="w-12 h-12 text-base" />
    )), [letters]
  );
...
const CrosswordExample: React.FC<{
  ...
  horizontalLetters: Array<{letter: string, color: 'green' | 'yellow' | 'gray' | 'white'}>,
  verticalLetters: Array<{letter: string, color: 'green' | 'yellow' | 'gray' | 'white'}>,
  title: string,
  description: string
}> = React.memo(({ centerLetter, centerColor, horizontalLetters, verticalLetters, title, description }) => {
  const renderedStructure = useMemo(() => (
    <div className="flex flex-col items-center">
      {/* Top letter */}
      <WaffleTile letter={verticalLetters[0].letter} color={verticalLetters[0].color} className="w-12 h-12 text-base mb-2" />

      {/* Horizontal row */}
      <div className="flex gap-2 items-center">
        <WaffleTile letter={horizontalLetters[0].letter} color={horizontalLetters[0].color} className="w-12 h-12 text-base" />
        <WaffleTile
          letter={centerLetter}
          color={centerColor}
          isIntersection={true}
        ...
        />
        <WaffleTile letter={horizontalLetters[1].letter} color={horizontalLetters[1].color} className="w-12 h-12 text-base" />
      </div>

      {/* Bottom letter */}
      <WaffleTile letter={verticalLetters[1].letter} color={verticalLetters[1].color} className="w-12 h-12 text-base mt-2" />
    </div>
...
const ColorMeaningGuide: React.FC = React.memo(() => {
  const headerContent = useMemo(() => (
    <div className="text-center mb-16">
      <h2 className="text-4xl font-bold text-slate-800 mb-8">🎨 Color Meaning Guide</h2>
      <div className="mb-8">
        <h3 className="text-2xl font-bold text-slate-800 mb-4">🔍 Color System Explanation</h3>
        <p className="text-slate-700 text-xl leading-relaxed max-w-4xl mx-auto">
          The Waffle game uses colors to indicate the status of each letter. Understanding these colors is key to solving the puzzle! Each letter's color is displayed based on its correctness in the current word.
        </p>
      </div>
    </div>
  ), []);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center gap-8 mb-10">
            <WaffleTile letter="O" color="green" className="w-16 h-16 text-xl" />
            <div className="text-center">
              <h3 className="text-3xl font-bold text-green-700 mb-2">🟢 Green - Correct Position</h3>
              <p className="text-green-600 text-xl">The letter is in the completely correct position in the word</p>
            </div>
          </div>

          <div className="text-center mb-12">
            <h4 className="text-xl font-bold text-green-800 mb-8">✅ Meaning of Green Letters:</h4>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
              <div className="text-green-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Belongs to Word</span>
                <p>This letter belongs to this word</p>
              </div>
              <div className="text-green-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Correct Position</span>
                <p>The letter's position is completely correct</p>
              </div>
              <div className="text-green-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">No Movement Needed</span>
                <p>No need to move this letter</p>
              </div>
              <div className="text-green-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Solving Anchor</span>
          ...
          <div className="text-center">
            <h4 className="text-xl font-bold text-green-800 mb-8">🎮 Game Scenario Examples</h4>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center gap-8 mb-10">
            <WaffleTile letter="R" color="yellow" className="w-16 h-16 text-xl" />
            <div className="text-center">
              <h3 className="text-3xl font-bold text-yellow-700 mb-2">🟡 Yellow - Wrong Position</h3>
              <p className="text-yellow-600 text-xl">The letter belongs to the word, but is in the wrong position</p>
            </div>
          </div>

          <div className="text-center mb-12">
            <h4 className="text-xl font-bold text-yellow-800 mb-8">⚠️ Meaning of Yellow Letters:</h4>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-yellow-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Wrong Position</span>
                <p>But the current position is incorrect</p>
              </div>
              <div className="text-yellow-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Needs Movement</span>
                <p>Need to find its correct position</p>
              </div>
              <div className="text-yellow-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Important Clue</span>
          ...
          <div className="text-center">
            <h4 className="text-xl font-bold text-yellow-800 mb-8">🎮 Game Scenario Examples</h4>
            <div className="grid lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
              <HorizontalWordExample
                letters={[
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center gap-8 mb-10">
            ...
            <div className="text-center">
              <h3 className="text-3xl font-bold text-gray-700 mb-2">⚫ Gray - Not in Word</h3>
              <p className="text-gray-600 text-xl">The letter does not belong to the word</p>
            </div>
          </div>

          <div className="text-center mb-12">
            <h4 className="text-xl font-bold text-gray-800 mb-8">❌ Meaning of Gray Letters:</h4>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
              <div className="text-gray-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Not in Word</span>
                <p>This letter does not belong to this word at all</p>
              </div>
              <div className="text-gray-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Needs Swapping</span>
                <p>Needs to be swapped with letters from other positions</p>
              </div>
              <div className="text-gray-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Final Step</span>
                <p>Usually the final step in solving the puzzle</p>
              </div>
              <div className="text-gray-700 text-lg text-center">
                <span className="block font-semibold mb-2 text-xl">Exclude Options</span>
          ...
          <div className="text-center">
            <h4 className="text-xl font-bold text-gray-800 mb-8">🎮 Game Scenario Examples</h4>
            <div className="grid lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
              <HorizontalWordExample
                letters={[
                  {letter: 'X', color: 'gray'},
        ...
        <div className="text-center bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">🎯 Strategy Summary</h3>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl mb-4">🟢</div>
              <h4 className="font-bold text-green-700 mb-2">Green First</h4>
              <p className="text-gray-600">First confirm green letter positions, they are correct</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🟡</div>
              <h4 className="font-bold text-yellow-700 mb-2">Move Yellow</h4>
              <p className="text-gray-600">Move yellow letters to their correct positions</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">⚫</div>
              <h4 className="font-bold text-gray-700 mb-2">Replace Gray</h4>
              <p className="text-gray-600">Replace gray letters with correct ones</p>
            </div>
          </div>
        </div>
      </div>
